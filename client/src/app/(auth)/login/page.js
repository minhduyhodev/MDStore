...
export default function LoginPage() {
  ...
  const handleLogin = (e) => {
    ...
    toast.success('Đăng nhập thành công!', {
      description: 'Chào mừng bạn quay trở lại MDStore.',
    });
    router.push('/catalog');
  };
        ...
        <div className="relative z-10 w-full max-w-lg px-12 text-slate-900">
          ...
          >
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight text-slate-900">
              Khởi nguồn cho hệ thống kinh doanh số của bạn.
            </h1>
            <p className="text-slate-600 text-lg leading-relaxed">
              Trải nghiệm nền tảng Dropshipping tài khoản số hiện đại, tích hợp API tự động và đối soát giao dịch tức thì.
            </p>
          </motion.div>
        </div>
      </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 sm:p-12 lg:p-24 relative">
        ...
        >
          <div className="mb-10 text-center lg:text-left">
            ...
            <p className="text-slate-500 dark:text-slate-400">Đăng nhập vào tài khoản của bạn để tiếp tục</p>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            ...
            <div className="space-y-1.5">
              <div className="flex items-center justify-between">
                ...
                <Link href="#" className="text-xs font-semibold text-indigo-600 hover:text-indigo-500 transition-colors">Quên mật khẩu?</Link>
              </div>
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none text-slate-400">
                  <Lock size={18} />
